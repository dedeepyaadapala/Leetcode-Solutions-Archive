...
//         // 0 - value, 1 - index, 2 - score
//         int[] pge = new int[n];
//         int[] nge = new int[n];
//         Stack<Integer> st = new Stack<>();
//         // System.out.print(pge[0] +" ");
//         for(int i = 0; i < n;i++){
//             int val = nums.get(i);
//             while(!st.isEmpty() && isPrime[val] >= isPrime[nums.get(st.peek())]){
//                 st.pop();
//             }
...
//         for(int i = 0;i < n;i++){
//             int val = nums.get(i);
//             pq.add(new int[]{val,i,isPrime[val]});
//         }
//         long res = 1l;
//         while(!pq.isEmpty() && k > 0){
//             int[] curr = pq.poll();
//             int left = curr[1] - pge[curr[1]];
//             long right = nge[curr[1]] - curr[1];
//             for(long i = 0;k > 0 && i < (left * right);i++){
//                 res = (res * curr[0]) % 1000000007;
//                 k--;
//             }
//         }
//         return (int) res;
